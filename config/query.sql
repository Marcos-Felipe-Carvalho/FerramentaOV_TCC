...
WHERE
    neuroticismo.id_user = 5


//*QUERY PARA COMPILAR OS RESULTADOS DO TESTE E REDAÇÃO*/
...
(
	SELECT
    	...
    	,ta.agreeableness_score
    	,ta.conscientiousness_level
    	,ta.conscientiousness_score
    	,ta.emotional_stability_level
    	,ta.emotional_stability_score
    	,ta.extraversion_level
    	,ta.extraversion_score
    	,ta.openness_level
    	,ta.openness_score
    FROM
    	tb_analysis_text ta
