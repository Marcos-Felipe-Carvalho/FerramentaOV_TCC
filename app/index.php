...
<body>
    <div class="login">
        ...
        <form class="needs-validation" method="post" action="model/authentication/login.php">
            ...
            <p class="text-center register">Ainda não possui cadastro?<a href="view/register.php"><span class="info-register">Cadastrar-se</span></a></p>
